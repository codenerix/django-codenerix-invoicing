...
class CashDiary(CodenerixModel):
    ...
    opened_cash = models.DecimalField(_("Opened Cash"), blank=False, null=False)
    opened_cash_extra = models.DecimalField(_("Opened Cash Deviation"), blank=True, null=True, default=None)
    opened_cash_notes = models.TextField(_("Opened Cash Notes"), blank=True, null=False, default="")
    opened_cards = models.DecimalField(_("Opened Cards"), blank=False, null=False)
    opened_cards_extra = models.DecimalField(_("Opened Cards Deviation"), blank=True, null=True, default=None)
    ...
    closed_cash = models.DecimalField(_("Closed Cash"), blank=True, null=True)
    closed_cash_extra = models.DecimalField(_("Closed Cash Deviation"), blank=True, null=True, default=None)
    closed_cash_notes = models.TextField(_("Closed Cash Notes"), blank=True, null=False, default="")
    closed_cards = models.DecimalField(_("Closed Cards"), blank=True, null=True)
    closed_cards_extra = models.DecimalField(_("Closed Cards Deviation"), blank=True, null=True, default=None)
...
class CashMovement(CodenerixModel):
    ...
    amount = models.DecimalField(_("Amount"), blank=False, null=False)
