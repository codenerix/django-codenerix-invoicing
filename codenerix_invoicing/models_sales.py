...
class GenCustomer(GenInterface, ABSTRACT_GenCustomer):  # META: Abstract class
    ...
    class CodenerixMeta:
        ...
        rol_permissions = [
            ...
            'add_citygeonameen',
            'add_citygeonamees',
            'add_citylocalenameen',
            'add_citylocalenamees',
            'add_continent',
            'add_continentgeonameen',
            'add_continentgeonamees',
            'add_continentlocalenameen',
            'add_continentlocalenamees',
            'add_corporateimage',
            'add_country',
            'add_countrygeonameen',
            'add_countrygeonamees',
            'add_countrylocalenameen',
            'add_countrylocalenamees',
            'add_customer',
            ...
            'add_provincelocalenameen',
            'add_provincelocalenamees',
            'add_region',
            'add_regiongeonameen',
            'add_regiongeonamees',
            'add_regionlocalenameen',
            'add_regionlocalenamees',
            'add_salesbasket',
            'add_saleslinebasket',
            'add_timezone',
            'change_city',
            ...
            'change_citylocalenameen',
            'change_citylocalenamees',
            'change_continent',
            'change_continentgeonameen',
            'change_continentgeonamees',
            'change_continentlocalenameen',
            'change_continentlocalenamees',
            'change_corporateimage',
            'change_country',
            'change_countrygeonameen',
            'change_countrygeonamees',
            'change_countrylocalenameen',
            'change_countrylocalenamees',
            'change_customer',
            ...
            'change_provincelocalenameen',
            'change_provincelocalenamees',
            'change_region',
            'change_regiongeonameen',
            'change_regiongeonamees',
            'change_regionlocalenameen',
            'change_regionlocalenamees',
            'change_salesbasket',
            ...
            'delete_citylocalenameen',
            'delete_citylocalenamees',
            'delete_continent',
            'delete_continentgeonameen',
            'delete_continentgeonamees',
            'delete_continentlocalenameen',
            'delete_continentlocalenamees',
            'delete_corporateimage',
            'delete_country',
            'delete_countrygeonameen',
            'delete_countrygeonamees',
            'delete_countrylocalenameen',
            'delete_countrylocalenamees',
            'delete_customer',
            ...
            'delete_provincelocalenameen',
            'delete_provincelocalenamees',
            'delete_region',
            'delete_regiongeonameen',
            'delete_regiongeonamees',
            'delete_regionlocalenameen',
            'delete_regionlocalenamees',
            'delete_salesbasket',
