...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AddField(
            model_name='salesreservedproduct',
            name='product',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='reservedproduct_sales', to='codenerix_products.ProductFinal', verbose_name='Product'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='salesorder',
            name='customer',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='order_sales', to='codenerix_invoicing.Customer', verbose_name='Customer'),
        ),
        migrations.AddField(
            model_name='salesorder',
            name='payment',
        ...
        migrations.AddField(
            ...
            name='line_ticket',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='line_ticketrectification_sales', to='codenerix_invoicing.SalesLineTicket', verbose_name='Line ticket'),
        ),
        migrations.AddField(
            model_name='saleslineticketrectification',
        ...
        migrations.AddField(
            ...
            name='line_order',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='line_ticket_sales', to='codenerix_invoicing.SalesLineOrder', verbose_name='Line order'),
        ),
        migrations.AddField(
            model_name='saleslineticket',
            name='ticket',
        ...
        migrations.AddField(
            model_name='saleslineorderoption',
            name='line_order',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='line_order_option_sales', to='codenerix_invoicing.SalesLineOrder', verbose_name='Line Order'),
        ),
        migrations.AddField(
            model_name='saleslineorderoption',
            name='product_final',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='line_order_option_sales', to='codenerix_products.ProductFinal', verbose_name='Product'),
        ),
        migrations.AddField(
            model_name='saleslineorderoption',
            name='product_option',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='line_order_option_sales', to='codenerix_products.ProductFinalOption', verbose_name='Option'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='line_invoicerectification_sales', to='codenerix_invoicing.SalesInvoiceRectification', verbose_name='Invoice rectification'),
        ),
        migrations.AddField(
            model_name='saleslineinvoicerectification',
            name='line_invoice',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='line_invoicerectification_sales', to='codenerix_invoicing.SalesLineInvoice', verbose_name='Line invoice'),
        ),
        migrations.AddField(
            model_name='saleslineinvoice',
            name='invoice',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='line_invoice_sales', to='codenerix_invoicing.SalesInvoice', verbose_name='Invoice'),
        ),
        migrations.AddField(
            model_name='saleslineinvoice',
            name='line_order',
        ...
        migrations.AddField(
            ...
            name='line_budget',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='line_basket_option_sales', to='codenerix_invoicing.SalesLineBasket', verbose_name='Line budget'),
        ),
        migrations.AddField(
            model_name='saleslinebasketoption',
            name='product_final',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='line_basket_option_sales', to='codenerix_products.ProductFinal', verbose_name='Product'),
        ),
        migrations.AddField(
            model_name='saleslinebasketoption',
            name='product_option',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='line_basket_option_sales', to='codenerix_products.ProductFinalOption', verbose_name='Option'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='saleslinebasket',
            name='product',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='line_basket_sales', to='codenerix_products.ProductFinal', verbose_name='Product'),
        ),
        migrations.AddField(
            model_name='saleslinealbaran',
            name='albaran',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='line_albaran_sales', to='codenerix_invoicing.SalesAlbaran', verbose_name='Albaran'),
        ),
        migrations.AddField(
            model_name='saleslinealbaran',
            name='line_order',
        ...
        migrations.AddField(
            model_name='salesinvoicerectification',
            name='invoice',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='invoicerectification_sales', to='codenerix_invoicing.SalesInvoice', verbose_name='Invoice'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='salesinvoice',
            name='customer',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='invoice_sales', to='codenerix_invoicing.Customer', verbose_name='Customer'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='salesbasket',
            name='customer',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='basket_sales', to='codenerix_invoicing.Customer', verbose_name='Customer'),
        ),
        migrations.AddField(
            model_name='salesbasket',
            name='haulier',
        ...
        migrations.AddField(
            model_name='salesbasket',
            name='payment',
            field=models.ManyToManyField(blank=True, related_name='basket_sales', to='codenerix_payments.PaymentRequest', verbose_name='Payment Request'),
        ),
        migrations.AddField(
            model_name='salesbasket',
            name='pos_slot',
        ...
        migrations.AddField(
            model_name='purchaseslinealbaran',
            name='validator_user',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='line_albaran_purchases', to=settings.AUTH_USER_MODEL, verbose_name='Validator user'),
        ),
        migrations.AddField(
